...
"CREATE TABLE IF NOT EXISTS software (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE, name TEXT NOT NULL, version TEXT NOT NULL, server_id INTEGER NOT NULL);",
